...
#include <iostream>
#include <string>
#include "TP2/queryProcessor.hpp"
...
string linkIt (string a){
    return "<p><a href=\"" + a + "\">"+a+"</a></p>";
    // content = "<p>" + alink + "</p>" + "<p>" + alink + "</p>";
}
...
int main() {
  ...
  server.resource["^/string$"]["POST"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request) {
    ...
    //auto content=ss.str();
    // string a = content.substr(7);
    // for (int i=0; i<a.size(); i++)  if (a[i] == '+')    a[i] = ' ';
    // cout << a << "\n";
    // vector<string> docs = qp.process(a);
    // cout << "Pesquisa retornou " << docs.size() << " documentos.\n";
    // // string alink = "<a href=\"http://google.com/\">" + a + "</a>";
    // // content = "<p>" + alink + "</p>" + "<p>" + alink + "</p>";
    // // string volta = "<form method=\"get\"> <input type=\"submit\" value=\"Voltar\"> </form>";
    // string tudo = "";
    // //
    // int limite = 10;
    ...
    *response << "HTTP/1.1 200 OK\r\nContent-Length: " << content.length() << "\r\n\r\n" << content;//"<h1>Documentos encontrados:</h1>"
              //<< content << volta;
  ...
  server.resource["^/query$"]["POST"] = [&qp](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request) {
    //Retrieve string:
    // cout << "OI\n";
    string delim = "+";
    auto content = request->content.string();
    ...
    *response << "HTTP/1.1 200 OK\r\nContent-Length: " << tudo.length() << "\r\n\r\n" << tudo;//"<h1>Documentos encontrados:</h1>"
              //<< content << volta;
  ...
  //   string alink = "<a href=\"http://google.com/\">" + a + "</a>";
  //   content = "<p>" + alink + "</p>" + "<p>" + alink + "</p>";
  //   string volta = "<input type=\"submit\" value=\"Voltar\">";
  //
  //   *response << "HTTP/1.1 200 OK\r\nContent-Length: " << content.length() << "\r\n\r\n" << code;//"<h1>Documentos encontrados:</h1>"
  //             //<< content << volta;
  //
  //
  // };
